...
inv1 = ReducedNeg(x1, gf)
inv2 = ReducedNeg(x2, gf)
inv3 = ReducedNeg(x3, gf)
inv4 = ReducedNeg(x4, gf)
inv5 = ReducedNeg(x5, gf)
inv6 = ReducedNeg(x6, gf)

mul1 = inv1 * inv2
invmul1 = ReducedNeg(mul1, gf)

mul2 = inv3 * inv4
invmul2 = ReducedNeg(mul2, gf)

mul3 = inv5 * inv6
invmul3 = ReducedNeg(mul3, gf)
...
inv1 = ReducedNeg(x1, gf).arithmetize("best-effort").to_arithmetic()
inv2 = ReducedNeg(x2, gf).arithmetize("best-effort").to_arithmetic()
inv3 = ReducedNeg(x3, gf).arithmetize("best-effort").to_arithmetic()
inv4 = ReducedNeg(x4, gf).arithmetize("best-effort").to_arithmetic()
inv5 = ReducedNeg(x5, gf).arithmetize("best-effort").to_arithmetic()
inv6 = ReducedNeg(x6, gf).arithmetize("best-effort").to_arithmetic()
inv7 = ReducedNeg(x7, gf).arithmetize("best-effort").to_arithmetic()
...
inv = ReducedNeg(mul6, gf).arithmetize("best-effort").to_arithmetic()
