...
if __name__ == "__main__":
    ...
    os.chdir(folder)
    params = arithmetic_circuit.generate_code_chunked("main.cpp", "split", measure_time=True, decrypt_outputs=True, iterations=10, overwrite_default_variable_value="std::rand() % 3 + 5")
