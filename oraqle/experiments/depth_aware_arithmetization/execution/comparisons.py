...
if __name__ == "__main__":
    ...
    for p in [29, 43, 61, 101, 131, 163, 107]:
        ...
        for d, s, circ in our_front:
            print(d, s, circ.run_using_helib(iterations=iterations, measure_time=True, x=15, y=22) if perform_runs else None)
        ...
        print(
            ...
            t2_arithmetization.run_using_helib(iterations=iterations, measure_time=True, x=15, y=22) if perform_runs else None
        )
        ...
        print(
            ...
            iz21_arithmetization.run_using_helib(iterations=iterations, measure_time=True, x=15, y=22) if perform_runs else None
        )
