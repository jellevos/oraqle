...
int main(int argc, char* argv[]) {
	...
	ctxt_t stack_2 = context->EvalMultNoRelin(stack_1, stack_1);
	context->RelinearizeInPlace(stack_2);
	...
	ctxt_t stack_4 = context->EvalMultNoRelin(stack_2, stack_2);
	context->EvalAddInPlace(stack_3, stack_4);
	context->RelinearizeInPlace(stack_3);
	stack_3 = context->EvalMult(stack_3, context->MakePackedPlaintext({ int64_t(6) }));
	stack_1 = context->EvalMultNoRelin(stack_1, stack_3);
	context->RelinearizeInPlace(stack_4);
	stack_2 = context->EvalMultNoRelin(stack_2, stack_4);
	context->RelinearizeInPlace(stack_2);
	...
	stack_4 = context->EvalMultNoRelin(stack_3, stack_3);
	context->RelinearizeInPlace(stack_4);
	...
	ctxt_t stack_6 = context->EvalMultNoRelin(stack_4, stack_4);
	context->EvalAddInPlace(stack_5, stack_6);
	context->RelinearizeInPlace(stack_5);
	stack_5 = context->EvalMult(stack_5, context->MakePackedPlaintext({ int64_t(6) }));
	stack_3 = context->EvalMultNoRelin(stack_3, stack_5);
	context->RelinearizeInPlace(stack_6);
	stack_4 = context->EvalMultNoRelin(stack_4, stack_6);
	context->RelinearizeInPlace(stack_4);
	stack_4 = context->EvalMult(stack_4, context->MakePackedPlaintext({ int64_t(4) }));
	context->EvalAddInPlace(stack_3, stack_4);
	context->RelinearizeInPlace(stack_1);
	context->RelinearizeInPlace(stack_3);
	stack_4 = context->EvalMultNoRelin(stack_1, stack_3);
	...
	stack_5 = context->EvalMultNoRelin(stack_5, stack_6);
	...
	stack_2 = context->EvalMultNoRelin(stack_0, stack_0);
	context->RelinearizeInPlace(stack_2);
	stack_5 = context->EvalMult(stack_2, context->MakePackedPlaintext({ int64_t(6) }));
	context->EvalAddInPlace(stack_5, context->MakePackedPlaintext({ int64_t(4) }));
	stack_6 = context->EvalMultNoRelin(stack_2, stack_2);
	context->EvalAddInPlace(stack_5, stack_6);
	context->RelinearizeInPlace(stack_5);
	stack_5 = context->EvalMult(stack_5, context->MakePackedPlaintext({ int64_t(6) }));
	stack_0 = context->EvalMultNoRelin(stack_0, stack_5);
	context->RelinearizeInPlace(stack_6);
	stack_2 = context->EvalMultNoRelin(stack_2, stack_6);
	context->RelinearizeInPlace(stack_2);
	stack_2 = context->EvalMult(stack_2, context->MakePackedPlaintext({ int64_t(4) }));
	context->EvalAddInPlace(stack_0, stack_2);
	context->RelinearizeInPlace(stack_4);
	context->RelinearizeInPlace(stack_0);
	stack_0 = context->EvalMultNoRelin(stack_4, stack_0);
	...
	stack_1 = context->EvalMultNoRelin(stack_1, stack_2);
